...
interface AdminAnalyticsModalProps {
  ...
  onAddInterest: (interest: string) => void | Promise<void>;
  onDeleteCategory: (category: string) => void | Promise<void>;
  onDeleteInterest: (interest: string) => void | Promise<void>;
  
  // Category Management Props (Fixed Interface)
  pendingCategories?: string[];
  onApproveCategory?: (category: string) => void | Promise<void>;
  onRejectCategory?: (category: string) => void | Promise<void>;
  onReassignCategory?: (oldCategory: string, newCategory: string) => void | Promise<void>;
  
  // Interest Management Props (Fixed Interface)
  pendingInterests?: string[]; 
  onApproveInterest?: (interest: string) => void | Promise<void>;
  onRejectInterest?: (interest: string) => void | Promise<void>;
}
